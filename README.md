...
| Занятие №5 | 29.10.2024 | Признаковое описание объектов в МО. Общая последовательность решения задач обучения с учителем. Проблема переобучения, тестовая и тренировочная выборки| [Ноутбук (пример с синтетическими данными)](https://github.com/mvarentsov/ML4hydromet-2024/blob/main/examples/Lect05_LRext_synthetic_data.ipynb)<br/>[Ноутбук (пример с реальными данными)](https://github.com/mvarentsov/ML4hydromet-2024/blob/main/examples/Lect05_LRext_real_data.ipynb)
